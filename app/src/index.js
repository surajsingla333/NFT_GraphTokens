...
buyToken: async function(tokenId, price) {  const { web3 } = this;  const { buyToken } = this.simpleExchange.methods;  await buyToken(tokenId).send({gas: 4700000, value: price,from: this.account});  alert("You have successfully purchased the NFT!");  location.reload("/"); },
